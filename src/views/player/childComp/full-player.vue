<template>
  <transition name="fade-full-player">
    <div class="full-player" ref="fullPlayer">
      <notice-bar
        :text="$store.getters.playMusicName"
        color="#fff"
        ref="noticeBar"
      >
      ...
      <div class="CD-lyrics">
        ...
        <div
          class="lyrics"
          v-show="currentShow === 'lyrics'"
          @click="currentShow = 'cd'"
        >
          <lyric-scroll class="lyric-scroll-wrapper" ref="lyricScroll">
            <div class="lyric-content">
              ...
              <p v-if="lyricData === null" class="lyric-state">
                {{ lyricState }}
              </p>
            </div>
          </lyric-scroll>
      ...
      >
        <div class="time" slot="time-current">
      ...
      <div class="play-operation">
        <div
          @click="changeMode"
          :class="modeICON"
          class="play-mode list-items"
        ></div>
        <div @click="prev" class="fa-step-backward prev list-items"></div>
        <div
          @click="playStatus"
          :class="[
            playStatu ? 'fa-stop-circle-o' : 'fa-play-circle-o',
            'status list-items',
          ]"
        ></div>
